...
|---|---:|---:|---:|---|---|
| `Hotel Reservations.csv` | 3.09 MB | 36275 | 19 | `useful` | `data/datasets/desktop_ingest_2026_03_20/Hotel Reservations.csv` |
| `hotel_bookings.csv` | 16.61 MB | 119390 | 33 | `high-value` | `data/datasets/desktop_ingest_2026_03_20/hotel_bookings.csv` |
| `README.json` | 348 B | - | 6 | `high-value` | `data/datasets/kaggle_hotel_booking_demand/README.json` |
| `hotel_bookings.csv` | 16.07 MB | 119390 | 32 | `high-value` | `data/datasets/kaggle_hotel_booking_demand/hotel_bookings.csv` |
