...
def compute_knowledge_inputs(
        ...
        areas_out.append(
            {
                ...
                "effective_validation_debt": float(dm.get("effective_validation_debt") or dm.get("validation_debt_score") or 0),
                "pending_debt_score": float(dm.get("pending_debt_score") or 0),
                "dismissal_residual_debt_score": float(dm.get("dismissal_residual_debt_score") or 0),
                "honest_validation_closure_score": dm.get("honest_validation_closure_score"),
    ...
    out = {
        ...
        "scoring_notes": {
            ...
            "validation_debt": "Deuda en validation_inbox.json: effective = pendiente + residual por dismissed (done elimina; dismiss no limpia como done). honest_validation_closure_score contrasta peso done vs dismissed.",
        },
        "areas": areas_out,
    }
